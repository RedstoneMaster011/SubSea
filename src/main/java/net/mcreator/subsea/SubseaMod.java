...
@Mod("subsea")
public class SubseaMod {
	public static final Logger LOGGER = LogManager.getLogger(SubseaMod.class);
	public static final String MODID = "subsea";
	...
	public SubseaMod() {
		...
		SubseaModMenus.REGISTRY.register(bus);
