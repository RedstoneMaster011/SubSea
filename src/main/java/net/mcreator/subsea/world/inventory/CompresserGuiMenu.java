...
public class CompresserGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CompresserGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(SubseaModMenus.COMPRESSER_GUI.get(), id);
		...
		this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 106, 35) {
			private final int slot = 4;
		}));
		this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 151, 35) {
